...
interface InvoicesIconProps extends SVGProps<SVGSVGElement> {
    width?: number | string;
    height?: number | string;
}

const InvoicesIcon = forwardRef<SVGSVGElement, InvoicesIconProps>(
