...
interface HelpIconProps extends SVGProps<SVGSVGElement> {
    width?: number | string;
    height?: number | string;
}

const HelpIcon = forwardRef<SVGSVGElement, HelpIconProps>(
