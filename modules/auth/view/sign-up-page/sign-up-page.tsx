...
export const SignUpPage = ({ className }: SignUpPageProps & SignUpPageVariants) => {
  ...
  return (
    <div className={cn(signUpPageVariants({ layout: 'default' }), className)}>
        ...
        <div className="flex-1 flex items-center justify-center px-8 py-8">
          <div className="w-full max-w-[404px] space-y-8">
            <div className="space-y-2">
              <h1 className="text-[30px] font-semibold text-[#1B212D] mb-2">Create new account</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <GoogleButton onClick={handleGoogleSignUp} disabled={registerMutation.isPending} />
            </form>
